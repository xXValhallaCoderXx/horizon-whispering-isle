...
function convertOre(player: hz.Player, rcData: Globals.ResourceConverterRecord) {
    ...
    NpcManager.onPlayerResourceConvert(player, `${amountOre} green ore`, `${amountOre * playerStats[0]} green currency`)
    ...
    NpcManager.onPlayerResourceConvert(player, `${amountOre} blue ore`, `${amountOre * playerStats[1]} blue currency`)
    ...
    NpcManager.onPlayerResourceConvert(player, `${amountOre} purple ore`, `${amountOre * playerStats[2]} purple currency`)
    ...
    NpcManager.onPlayerResourceConvert(player, `${amountOre} red ore`, `${amountOre * playerStats[3]} red currency`)
