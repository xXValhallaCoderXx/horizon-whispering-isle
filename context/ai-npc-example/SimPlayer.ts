...
export class SimPlayer {
    ...
    constructor(player: hz.Player, world: hz.World) {
        ...
        const currencies = ['GREEN_ORE', 'BLUE_ORE', 'PURPLE_ORE', 'RED_ORE', 'GREEN_CURRENCY', 'BLUE_CURRENCY', 'PURPLE_CURRENCY', 'RED_CURRENCY'];
        for(const currency of currencies) {
            NpcManager.setPlayerResource(currency, this.getPlayerResource(currency), this.player);
        }
    }
    ...
    public equipAttachable(toolName: string) {
        ...
        NpcManager.onPlayerAttached(this.player, toolName)
    }
    ...
    public equipGrabbable(toolName: string) {
        ...
        NpcManager.onPlayerEquipped(this.player, toolName)
    }
    ...
    public setPlayerResource(type: string, value: number) {
        ...
        NpcManager.setPlayerResource(type, value, this.player);
    }
